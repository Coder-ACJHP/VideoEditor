    ...
    func loadStoredProjects() {
        ...
        allProjects = [
            EditingProject(
                    ...
                    MediaTrack(
                        ...
                        clips: [
                            MediaClip(
                                ...
                                timelineOffset: .zero,
                                duration: policy.preferredImageDuration,
                                transitionOut: nil,
                                opacity: 1.0
                            ),
                            MediaClip(
                            ...
                            MediaClip(
                                id: UUID(),
                                imageAsset: .image(Bundle.main.bundleURL.appendingPathComponent("img3.jpg")),
                                timelineOffset: 6.0,
                                duration: policy.preferredImageDuration,
                                transitionOut: nil,
                                opacity: 1.0
                            ...
                            MediaClip(
                                id: UUID(),
                                imageAsset: .image(Bundle.main.bundleURL.appendingPathComponent("img4.jpg")),
                                timelineOffset: 9.0,
                                duration: policy.preferredImageDuration,
                                transitionOut: nil,
                                opacity: 1.0
                            ...
                            MediaClip(
                                id: UUID(),
                                imageAsset: .image(Bundle.main.bundleURL.appendingPathComponent("img5.jpg")),
                                timelineOffset: 12.0,
                                duration: policy.preferredImageDuration,
                                transitionOut: nil,
                                opacity: 1.0
                    ...
                    MediaTrack(
                        ...
                        clips: [
                            MediaClip(
                                ...
                                timelineOffset: .zero,
                                duration: policy.preferredStickerDuration,
                                transitionOut: nil,
                                opacity: 1.0
                            )
                        ],
                    ...
                    MediaTrack(
                        ...
                        clips: [
                            MediaClip(
                                ...
                                timelineOffset: .zero,
                                duration: policy.preferredTextDuration,
                                transitionOut: nil,
                                opacity: 1.0
                            )
                        ],
                ...
                canvasBackground: CanvasBackgroundSettings(style: .solid, primaryHex: "#415A77", secondaryHex: nil),
                exportSettings: ExportSettings.default
            ),
            EditingProject(
                id: UUID(),
                name: "Mock Image Project",
