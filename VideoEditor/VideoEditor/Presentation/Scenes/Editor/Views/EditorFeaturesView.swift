...
extension FeatureItem {
    ...
    static var mainMenuItems: [FeatureItem] { [
        ...
        FeatureItem(id: "canvasBg", title: "Canvas",   icon: UIImage(systemName: "paintpalette")),
    ] }
    ...
    static func subMenuItems(for mediaType: AssetIdentifier.MediaType) -> [FeatureItem] {
        switch mediaType {
            ...
            case .text:
                return [
                    FeatureItem(id: "textEdit", title: String(localized: "Edit"), icon: UIImage(systemName: "square.and.pencil")),
